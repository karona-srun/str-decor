...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $product_sub_category = ProductSubCategory::orderBy('id', 'desc')->get();
        return view('backend.products.create', compact('product_category','product_sub_category'));
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'product_sub_category.required' => __('app.product_sub_category') . __('app.required'),
    ...
    public function edit($id)
    {
        ...
        $product_sub_category = ProductSubCategory::orderBy('id', 'desc')->get();
        $attachments = Attachment::where(['type_id' => $id, 'type' => 'product'])->get();
        return view('backend.products.edit', compact('product', 'product_category','product_sub_category', 'attachments'));
    }

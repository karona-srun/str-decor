...
class StaffInfoController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.staffinfo.create', compact('times','depart','position','workPlace','baseSalary'));
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(),[
            ...
            'department.required' => __('app.department_name').' '.__('app.required'),
    ...
    public function show($id)
    {
        ...
        return view('backend.staffinfo.show', compact('attachments','depart','times','staffInfo','position','workPlace','baseSalary'));
    }
    ...
    public function staffExport() 
    {
        ...
        $staff = $datas->map(function ($data) {
            return [
                ...
                'phone' => $data->phone,
                'email' => $data->email,
                'birth_of_date' => Carbon::parse($data->birth_of_date)->format('d-m-Y'),

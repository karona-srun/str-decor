                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="item_sub_group" id="item_sub_group" class="select2 form-control">
                                                    ...
                                                    @foreach ($itemSubGroups as $isg)
                                                        <option value="{{$isg->id}}">{{$isg->item_sub_group_name}}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('item_group'))
                                                    <div class="error text-danger text-sm mt-1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="any" name="buying_price" class="form-control">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select name="condition" id="status" class="select2s form-control">
                                                    <option value="0">{{ __('app.label_old_item') }}</option>
                                                    <option value="1">{{ __('app.label_new_item') }}</option>
                                                    <option value="2">{{ __('app.label_second_hand_item') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>

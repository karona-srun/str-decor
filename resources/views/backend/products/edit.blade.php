                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="text-center mb-2 container">
                                        <img id="blah"
                                            src="{{ asset( $product->photo == "" ? 'images/product_image.png' : url('products/',$product->photo)) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="product_sub_category"
                                                    ...
                                                    @foreach ($product_sub_category as $psc)
                                                        <option value="{{ $psc->id }}" {{ $product->product_sub_category_id == $psc->id ? "selected" : "" }}>
                                                            {{ $psc->code }} | {{ $psc->name }}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('product_sub_category'))
                                                    <div class="error text-danger text-sm mt-1">
                                                        {{ $errors->first('product_sub_category') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-sm-3">

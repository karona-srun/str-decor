                ...
                <nav>
                    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent mb-5" data-widget="treeview"
                        ...
                        @if (Auth::user()->can('Staff List') ||
                            ...
                            <li
                                class="nav-item {{ Request::is('staff-info*') || Request::is('positions*') || Request::is('workplace*') || Request::is('base-salary*') || Request::is('department*') || Request::is('payroll*') ? 'menu-is-opening menu-open' : null }} ">
                                <a href="#"
                        ...
                        @endcan
                        @if (Auth::user()->can('Product Category List') || Auth::user()->can('Product Sub Category List') || Auth::user()->can('Product List'))
                            <li
                                class="nav-item {{ Request::is('product-category*') || Request::is('product-sub-category*') || Request::is('productes*') || Request::is('import-product*') || Request::is('sales-order*') ? 'menu-is-opening menu-open' : null }} ">
                                <a href="#"
                                    class="nav-link {{ Request::is('product-category*') || Request::is('product-sub-category*') ||Request::is('productes*') || Request::is('import-product*') || Request::is('sales-order*') ? 'active' : null }} ">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    @can('Product Sub Category List')
                                        <li class="nav-item">
                                            <a href="{{ url('product-sub-category') }}"
                                                class="nav-link {{ Request::is('product-sub-category*') ? 'active' : null }}">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>{{ __('app.product_sub_category') }}</p>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('Product List')
                        ...
                        @endif
                        {{-- Menu items --}}
                        @if (Auth::user()->can('Item Group List') ||
                                Auth::user()->can('Item Sub Group List') ||
                                Auth::user()->can('Item List') ||
                                Auth::user()->can('Item Adjustment List'))
                            <li class="nav-item {{ Request::is('item-group*') || Request::is('item-sub-group*') || Request::is('itemes*') || Request::is('adjustment*') ? 'menu-is-opening menu-open' : null }}">
                                <a href="#"
                                    class="nav-link {{  Request::is('item-group*') || Request::is('item-sub-group*') || Request::is('itemes*') || Request::is('adjustment*') ? 'active' : null }}">
                                    ...
                                    @can('Item Group List')
                                        <li class="nav-item">
                                            <a href="{{ URL('/item-group') }}"
                                                class="nav-link {{ Request::is('item-group*') ? 'active' : null }} ">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>{{ __('app.item_group') }}</p>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('Item Sub Group List')
                                        <li class="nav-item">
                                            <a href="{{ url('item-sub-group') }}"
                                                class="nav-link {{ Request::is('item-sub-group*') ? 'active' : null }} ">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>{{ __('app.item_sub_group') }}</p>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('Item List')
                                        <li class="nav-item">
                                            <a href="{{ url('itemes') }}"
                                                class="nav-link {{ Request::is('itemes*') ? 'active' : null }} ">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>{{ __('app.item') }}</p>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('Item Adjustment List')
                                        <li class="nav-item">
                                            <a href="{{ url('adjustment') }}"
                                                class="nav-link {{ Request::is('adjustment*') ? 'active' : null }} ">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>{{ __('app.item_adjustment') }}</p>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>

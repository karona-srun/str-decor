...
use App\Http\Controllers\ItemSubGroupsController;
...
Route::get('/privacy-policy', [App\Http\Controllers\WelcomeController::class, 'index']);
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::resource('item-group', ItemGroupsController::class);
    Route::resource('item-sub-group', ItemSubGroupsController::class);
